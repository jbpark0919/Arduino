...
float dist_min, dist_max, dist_raw, dist_prev, dist_ema, alpha, rem_dist; // unit: mm
...
myservo.writeMicroseconds(_DUTY_MIN + (dist_ema-180.0)*10.25);

if(180.0 < rem_dist && rem_dist<360.0){
